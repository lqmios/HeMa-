...
@interface Brand_ViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation Brand_ViewController
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].brandTextField = _str;
}
