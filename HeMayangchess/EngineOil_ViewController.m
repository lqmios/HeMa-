...
@interface EngineOil_ViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation EngineOil_ViewController
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].textFieldStr_4 = _str;
}
