...
@interface Flat_ViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation Flat_ViewController
...
- (void)viewDidLoad {
    ...
    self.title = @"选择扁平比";
    //取出文件中的数组
    NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"flat" ofType:@"plist"];
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].flatTextField = _str;
}
