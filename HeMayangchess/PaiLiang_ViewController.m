...
@interface PaiLiang_ViewController ()<UITableViewDataSource,UITableViewDelegate>
{
...
@implementation PaiLiang_ViewController
...
- (void)viewDidLoad {
    ...
    self.title = @"选择汽车排量";
   //取出文件中的数组
    NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"pailiang" ofType:@"plist"];
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].textFieldStr_2 = _str;
}
