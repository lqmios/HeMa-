...
@interface Price_ViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation Price_ViewController
...
- (void)viewDidLoad {
    ...
    //取出文件中的数组
    NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"price" ofType:@"plist"];
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].textFieldStr_5 = _str;
}
