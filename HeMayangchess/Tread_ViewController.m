...
@interface Tread_ViewController ()<UITableViewDataSource,UITableViewDelegate>
...
@implementation Tread_ViewController
...
- (void)viewDidLoad {
    ...
    //取出文件中的数组
    NSString *plistPath = [[NSBundle mainBundle]pathForResource:@"tread" ofType:@"plist"];
...
-(void)sureBtnAcion:(UIButton *)sender
{
    ...
    [UserModel sharedUserModel].treadTextField = _str;
}
