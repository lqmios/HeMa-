...
//    pageControl.pageIndicatorTintColor = [UIColor lightGrayColor];
     pageControl.pageIndicatorTintColor = COLOR(250, 250, 250, 0.5);
    ...
    switch (self.pageControlAlignment)
    {
        case ZJCycleScrollViewPageControlAlignmentRight:
            pageControl.center = CGPointMake(self.bounds.size.width*1/2, self.bounds.size.height - 5);
            pageControl.bounds = CGRectMake(0, 0, size.width, 20);
            break;
        case ZJCycleScrollViewPageControlAlignmentCenter:
            pageControl.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height - 5);
            pageControl.bounds = CGRectMake(0, 0, size.width, 20);
            break;
        default:
            break;
